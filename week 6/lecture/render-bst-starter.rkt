...
(define VSPACE (rectangle 1 10 "solid" TEXT-COLOR))
(define HSPACE (rectangle 10 1 "solid" TEXT-COLOR))

(define MTTREE (rectangle 20 10 "solid" TEXT-COLOR))
...
(check-expect (render-bst BST1) (above (text
                                 (string-append "1" KEY-VAL-SEPARATOR "abc")
                                 TEXT-SIZE
                                 TEXT-COLOR)
                                       VSPACE
...
(check-expect (render-bst BST4) (above
                                 (text
                                  (string-append "4" KEY-VAL-SEPARATOR "dcj")
                                  TEXT-SIZE
                                  TEXT-COLOR)
                                 VSPACE
                                 (beside (render-bst false)
...
(check-expect (render-bst BST3) (above
                                 (text
                                  (string-append "3" KEY-VAL-SEPARATOR "ilk")
                                  TEXT-SIZE
                                  TEXT-COLOR)
                                 VSPACE
                                 (beside
